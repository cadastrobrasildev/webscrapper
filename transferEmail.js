...
AND c.address_fu = '${process.env.TRANSFER_UF}' 
  ...
  AND (
        c.email LIKE '%gmail%' OR
        c.email LIKE '%yahoo%' OR
        c.email LIKE '%hotmail%' OR
        c.email LIKE '%outlook%' OR
        c.email LIKE '%contador%' OR
        c.email LIKE '%icloud%' OR
        c.email LIKE '%uol%' OR
        c.email LIKE '%terra%' OR
        c.email LIKE '%brturbo%' OR
        c.email LIKE '%aol%' OR
        c.email LIKE '%msn%' OR
        c.email LIKE '%live%' OR
        c.email LIKE '%protonmail%' OR
        c.email LIKE '%zoho%' OR
        c.email LIKE '%mail.com%' OR
        c.email LIKE '%gmx%' OR
        c.email LIKE '%yandex%' OR
        c.email LIKE '%bol%'
      )
ORDER BY random()
LIMIT 20000;
